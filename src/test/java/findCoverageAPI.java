...
public class findCoverageAPI {
    ...
    @CsvFileSource(resources = "/Testcases - Health companion - Inpatient.csv", numLinesToSkip = 1)
    public void testing(String TestCaseId,
                        String product_code,
                        String benefit_category,
                        String benefit_type,
                        String benefit_code,
                        String personal_accident_cover_sum_insured,
                        String policy_enhancement_type,
                        String claim_submission_type,
                        String policy_base_sum_insured,
                        String reason_for_hospitalization,
                        String patient_days_of_hospitalization_during_policy_year,
                        String benefit_covered,
                        String benefit_exclusion_exceptions,
                        String benefit_coverage_failed_rules,
                        String benefit_waiting_period,
                        String benefit_default_waiting_period_for_PEDs,
                        String limit_per_claim,
                        String limit_per_day) throws ParseException {
        ...
        String benefitCoverageFailedRules = "";
        ...
        List<Map<String, Object>> benefitCoverageFailedList = jsonPathEvaluator.getList("benefit_coverage_failed_rules");
        ...
        try {
            ...
            if (benefitCoverageFailedList != null) {

                benefitCoverageFailedRules = benefitCoverageFailedList.get(0).get("code").toString();

                actualOutput.append("benefit_coverage_failed_rules : " + benefitCoverageFailedRules);
            }
            ...
            if (benefit_coverage_failed_rules != null) {

                expectedOutput.append("benefit_coverage_failed_rules : " + benefit_coverage_failed_rules + "\n");
            ...
            if (benefit_exclusion_exceptions != null) {
                ...
                benefitCoverageFailedRules = benefitExclusionExceptionsList.get(0).get("code").toString();

                if (!benefit_exclusion_exceptions.equals(benefitCoverageFailedRules)) {

                    differingFields.append("benefit_exclusion_exceptions is not matching ==> Expected :" + benefit_exclusion_exceptions + " Actual :" + benefitCoverageFailedRules + "\n");
            ...
            if(benefit_coverage_failed_rules != null){
                ...
                Assertions.assertEquals(benefit_coverage_failed_rules, benefitCoverageFailedRules, "Benefit Coverage Failed Rules is not matching");
